...
def translate(words):
    ...
    for hidden in hiddens:
        eles = selector.xpath("//div[@%s='%s']" % hidden)
        if eles:
            eles[0].attrib['style'] = 'display:none'
    ...
    content = content.replace('href="/example', 'href="http://dict.youdao.com/example')
...
if __name__ == "__main__":
    ...
    if len(argv) > 1:
        ...
        result = translate('example_apple')
    print(result)
